    ...
    <header id="mobile_home_header">
        ...
        <div class="logo_container" class:hidden={!isPageLoaded} class:transitioned={isPageLoaded}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 25" >
                ...
                <h1 class:hidden={!isPageLoaded} class:transitioned={isPageLoaded}>This is the portfolio of the <u><a href={resolve('/about')}>Design team</a></u>, inside mèdialab Sciences Po</h1>
...
{:else if props.type === 'project'}
    <header id="mobile_home_header" style="min-height: unset; height: fit-content;">
        {@render colorswitch_container()}
        <a class="hover_container" href={resolve('/')} id="backhome" data-sveltekit-preload-data aria-label="Back to home" style="left: unset; right: var(--spacing-m); align-items: flex-end; transition-delay: 1s;" class:hidden={!isPageLoaded} class:transitioned={isPageLoaded}>
...
<header id="desktop_header">
    ...
    {@render colorswitch_container()}
        ...
        <div class="navigator_container">
            ...
            <div class="navigator_links">
                <a href={resolve('/')} style="opacity:{props.isAbout ? '0.5' : '1'}; pointer-events:{props.isAbout ? 'auto' : 'none'}">
                    <p>mosaic</p>
                </a>
                <p>/</p>
                <a href={resolve('/about')} style="opacity:{props.isAbout ? '1' : '0.5'}; pointer-events:{props.isAbout ? 'none' : 'auto'}">
                    <p>about</p>
                </a>
            </div>
        </div>
