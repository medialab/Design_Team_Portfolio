...
{#snippet navigator_container()}
	{#if page.route.id === '/'}
		<div class="navigator_container flex self-center">
			...
			<div class="flex md:hidden items-center" id="info_icon">
				<a href={resolve('/about')} aria-label="Navigate to about page" class="flex items-center justify-center p-1">
	...
	{:else}
		<div class="navigator_container flex items-center self-center">
			<a
			...
			>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -720 700 800" class="w-5 h-5"
					><path
